...
params:
  ...
  output_path: "output/sequencing/05-subcluster_process-RNA/"
  dimn: 20
title: "Transform subcluster datasets: `r params$id` `r params$class`"
...
array <- readRDS(paste0(input, id, "_", cell_class, "_initial.rds"))
