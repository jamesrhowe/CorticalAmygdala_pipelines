...
```{r 7-filter_marker_lists, message = FALSE, warning = FALSE, results = "hide"}
# region-specific
...
```{r 8-markers_list_tissue, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 9-markers_list_class, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 10-markers_list_aplCoA_tissue, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 11-markers_list_aplCoA_class, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 12-markers_list_pplCoA_tissue, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 13-markers_list_cea_class, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 14-deg_abundance_tissue_aplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 1}
...
```{r 15-deg_abundance_tissue_pplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 1}
...
```{r 16-deg_abundance_magnitude_tissue_aplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 1}
deg_abundance_plot_magnitude(marker_tissue_region_aplCoA, deg_intensity_colors_aplCoA, deg_range_tissue, "aplCoA")
```

##### pplCoA

```{r 17-deg_abundance_magnitude_tissue_pplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 1}
...
```{r 18-deg_abundance_class_aplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 2, fig.width = 3.5}
...
```{r 19-deg_abundance_class_pplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 2, fig.width = 3.5}
...
```{r 20-deg_abundance_magnitude_class_aplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 2, fig.width = 3.5}
deg_abundance_plot_magnitude(marker_class_region_aplCoA, deg_intensity_colors_aplCoA, deg_range_class, "aplCoA")
```

##### pplCoA

```{r 21-deg_abundance_magnitude_class_pplCoA, message = FALSE, warning = FALSE, results = "hide", fig.height = 2, fig.width = 3.5}
deg_abundance_plot_magnitude(marker_class_region_pplCoA, deg_intensity_colors_pplCoA, deg_range_class, "pplCoA")
```

# enrichR {.tabset}

```{r 22-start_enrichR, message = FALSE, warning = FALSE}
...
```{r 23-run_enrichR-tissue, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r 24-run_enrichR-class, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r 25-run_enrichR-region-tissue, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r 26-run_enrichR-region-class, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r 27-save_matrices, message = FALSE, warning = FALSE}
