...
```{r 8-retro_proportion_plot, message = FALSE, warning = FALSE, fig.height = 2.6, fig.width = 2}
...
```{r 25-brain_2color, message = FALSE, warning = FALSE, fig.height = 2.6, fig.width = 2}
# set up the object with pointers
...
```{r 27-nacmea_solo, message = FALSE, warning = FALSE, fig.height = 3.2, fig.width = 2.6}
...
```{r 28-vg1vg2_solo, message = FALSE, warning = FALSE, fig.height = 3.2, fig.width = 2.6}
...
```{r 30-correlation_anterograde_sypegfp, message = FALSE, warning = FALSE}
