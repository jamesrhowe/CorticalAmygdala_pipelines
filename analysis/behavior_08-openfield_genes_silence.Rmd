...
params:
  dataset: "genes"
  path: "data/behavior/genes_silence_openfield/"
...
gene_sal_array <- transform_openfield_centertime(data_gene_sal, 
                                                 "full", "Region", 1, 2400)

gene_cno_array <- transform_openfield_centertime(data_gene_cno, 
                                                 "full", "Region", 1, 2400)

centertime_group_gene <- group_array(data_gene_sal, gene_sal_array, gene_cno_array, "CenterTime")
```

#### VGlut1

```{r 3-VGlut1_centertime_stats, message = FALSE, warning = FALSE}
VGlut1_group_gene <- centertime_group_gene[centertime_group_gene$group 
...
```{r 4-VGlut2_centertime_stats, message = FALSE, warning = FALSE}
VGlut2_group_gene <- centertime_group_gene[centertime_group_gene$group 
...
```{r 5-VGlut1_center_anova, message = FALSE, warning = FALSE}
display_anova(VGlut1_group_gene, "CenterTime")
```

##### Pairwise comparisons

```{r 6-VGlut1_center_pairwise, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut1_group_gene, "CenterTime")
```

##### T-test each

```{r 7-VGlut1_ttest_centertimes2, message = FALSE, warning = FALSE}
# SAL
...
```{r 8-VGlut2_center_anova_prepost, message = FALSE, warning = FALSE}
display_anova(VGlut2_group_gene, "CenterTime")
```

##### Pairwise comparisons

```{r 9-VGlut2_open_pairwise_prepost, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut2_group_gene, "CenterTime")
```

##### T-test each

```{r 10-VGlut2_ttest_centertimes2, message = FALSE, warning = FALSE}
# SAL
...
```{r 11-VGlut1_center_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut1_group_gene, "Proportion Time in Center", 
                       c(control_color, VGlut1_color), openfield_center_axes_genes, "white")
```

#### VGlut2

```{r 12-VGlut2_center_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut2_group_gene, "Proportion Time in Center", 
                       c(control_color, VGlut2_color), openfield_center_axes_genes, "white")
```
...
gene_sal_array <- transform_openfield_cornertime(data_gene_sal, 
                                                 "full", "Corner", 1, 2400)

gene_cno_array <- transform_openfield_cornertime(data_gene_cno, 
                                                 "full", "Corner", 1, 2400)

cornertime_group_gene <- group_array(data_gene_sal, gene_sal_array, gene_cno_array, "CornerTime")
```

#### VGlut1

```{r 14-VGlut1_cornertime_stats, message = FALSE, warning = FALSE}
VGlut1_group_gene <- cornertime_group_gene[cornertime_group_gene$group 
                                     %in% c("VGlut1 Gi", "VGlut1 mCh"),] %>%
...
```{r 15-VGlut2_Cornertime_stats, message = FALSE, warning = FALSE}
VGlut2_group_gene <- cornertime_group_gene[cornertime_group_gene$group 
                                     %in% c("VGlut2 Gi", "VGlut2 mCh"),] %>%
  gather(key = "time", value = "CornerTime", baseline_CornerTime, treatment_CornerTime) %>%
  convert_as_factor(group, time)
levels(VGlut2_group_gene$time) <- c("SAL", "CNO")
...
```{r 16-VGlut1_Corner_anova, message = FALSE, warning = FALSE}
display_anova(VGlut1_group_gene, "CornerTime")
```

##### Pairwise comparisons

```{r 17-VGlut1_Corner_pairwise, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut1_group_gene, "CornerTime")
```

##### T-test each

```{r 18-VGlut1_ttest_Cornertimes2, message = FALSE, warning = FALSE}
# SAL
...
```{r 19-VGlut2_Corner_anova_prepost, message = FALSE, warning = FALSE}
display_anova(VGlut2_group_gene, "CornerTime")
```

##### Pairwise comparisons

```{r 20-VGlut2_open_pairwise_prepost, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut2_group_gene, "CornerTime")
```

##### T-test each

```{r 21-VGlut2_ttest_Cornertimes2, message = FALSE, warning = FALSE}
# SAL
...
bg_twogroup(VGlut1_group_gene, "Proportion Time in Corner", 
            c(control_color, VGlut1_color), openfield_corner_axes_genes, "white")
```

#### VGlut2

```{r 23-VGlut2_Corner_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut2_group_gene, "Proportion Time in Corner", 
            c(control_color, VGlut2_color), openfield_corner_axes_genes, "white")
```
...
gene_sal_array <- transform_openfield_mobility(data_gene_sal, "full", "Freezing", 1, 2400)

gene_cno_array <- transform_openfield_mobility(data_gene_cno, "full", "Freezing", 1, 2400)

freezing_group_gene <- group_array(data_gene_sal, gene_sal_array, gene_cno_array, "Freezing")
```

#### VGlut1

```{r 25-VGlut1_freezing_stats, message = FALSE, warning = FALSE}
VGlut1_group_gene <- freezing_group_gene[freezing_group_gene$group 
                                     %in% c("VGlut1 Gi", "VGlut1 mCh"),] %>%
...
```{r 26-VGlut2_freezing_stats, message = FALSE, warning = FALSE}
VGlut2_group_gene <- freezing_group_gene[freezing_group_gene$group 
                                     %in% c("VGlut2 Gi", "VGlut2 mCh"),] %>%
  gather(key = "time", value = "Freezing", baseline_Freezing, treatment_Freezing) %>%
  convert_as_factor(group, time)
levels(VGlut2_group_gene$time) <- c("SAL", "CNO")
...
```{r 27-VGlut1_freezing_anova, message = FALSE, warning = FALSE}
display_anova(VGlut1_group_gene, "Freezing")
```

##### Pairwise comparisons

```{r 28-VGlut1_freezing_pairwise, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut1_group_gene, "Freezing")
```

##### T-test each

```{r 29-VGlut1_ttest_freezing, message = FALSE, warning = FALSE}
# SAL
...
```{r 30-VGlut2_freezing_anova_prepost, message = FALSE, warning = FALSE}
display_anova(VGlut2_group_gene, "Freezing")
```

##### Pairwise comparisons

```{r 31-VGlut2_freezing_pairwise_prepost, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut2_group_gene, "Freezing")
```

##### T-test each

```{r 32-VGlut2_ttest_freezing, message = FALSE, warning = FALSE}
# SAL
...
```{r 33-VGlut1_freezing_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut1_group_gene, "Proportion Time Freezing", 
            c(control_color, VGlut1_color), openfield_corner_axes_genes, "white")
```

#### VGlut2

```{r 34-VGlut2_freezing_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut2_group_gene, "Proportion Time Freezing", 
            c(control_color, VGlut2_color), openfield_freeze_axes_genes, "white")
```
...
```{r 36-VGlut1_distance_stats, message = FALSE, warning = FALSE}
...
```{r 37-VGlut2_distance_stats, message = FALSE, warning = FALSE}
...
```{r 38-VGlut1_distance_anova, message = FALSE, warning = FALSE}
display_anova(VGlut1_group_gene, "Distance")
```

##### Pairwise comparisons

```{r 39-VGlut1_distance_pairwise, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut1_group_gene, "Distance")
```

##### T-test each

```{r 40-VGlut1_ttest_distance, message = FALSE, warning = FALSE}
# SAL
...
```{r 41-VGlut2_distance_anova_prepost, message = FALSE, warning = FALSE}
display_anova(VGlut2_group_gene, "Distance")
```

##### Pairwise comparisons

```{r 42-VGlut2_distance_pairwise_prepost, message = FALSE, warning = FALSE}
pairwise_comp_anova(VGlut2_group_gene, "Distance")
```

##### T-test each

```{r 43-VGlut2_ttest_distance, message = FALSE, warning = FALSE}
# SAL
...
```{r 44-VGlut1_distance_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut1_group_gene, "Distance (m)", 
            c(control_color, VGlut1_color), openfield_axes_dist_silence, "white")
```

#### VGlut2

```{r 45-VGlut2_distance_prepost, message = FALSE, warning = FALSE, dev = "pdf", fig.height = 2.4, fig.width= 2.4}
bg_twogroup(VGlut2_group_gene, "Distance (m)", 
            c(control_color, VGlut2_color), openfield_axes_dist_silence, "white")
```

# Heatmaps {.tabset}

```{r 46-get_heatmaps, message = FALSE, warning = FALSE}
sal_heatmap <- get_heatmap_openfield(data_gene_sal, "full")
cno_heatmap <- get_heatmap_openfield(data_gene_cno, "full")
```
...
```{r 47-VGlut1_mCh_sal_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
plot_heatmap_openfield_diff(sal_heatmap$`VGlut1-control`)
```

#### CNO

```{r 48-VGlut1_mCh_cno_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r 49-VGlut1_Gi_sal_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
plot_heatmap_openfield(sal_heatmap$`VGlut1-Gi`)
```

#### CNO

```{r 50-VGlut1_Gi_cno_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r 51-VGlut2_mCh_sal_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
plot_heatmap_openfield(sal_heatmap$`VGlut2-control`)
```

#### CNO

```{r 52-VGlut2_mCh_cno_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r 53-VGlut2_Gi_sal_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
plot_heatmap_openfield(sal_heatmap$`VGlut2-Gi`)
```

#### CNO

```{r 54-VGlut2_Gi_cno_heatmap, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r 55-scale_bar_horizontal, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
...
```{r 56-scale_bar_vertical, message = FALSE, warning = FALSE, fig.height = 3, fig.width = 3}
