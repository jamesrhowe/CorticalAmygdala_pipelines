...
params:
  ...
  dimn: 9
title: "MOL cell type classification (final): `r params$id`"
...
absolute_bar_plot_formatted(plot_group_array, 'Region', 'Type', mol_type_colors)
```

#### Relative

```{r 28-region_relative, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 3}
relative_bar_plot_formatted(plot_group_array, 'Region', 'Type', mol_type_colors) +
...
absolute_bar_plot_formatted(plot_group_array, 'Batch', 'Type', mol_type_colors)
```

#### Relative

```{r 31-region_relative, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 4}
relative_bar_plot_formatted(plot_group_array, 'Batch', 'Type', mol_type_colors) +
  geom_hline(yintercept = table(array$Type)[2] / length(array$Type), linetype = "dashed")
```
...
type_dend <- create_dendrogram(array, as.factor(array$Type), mol_type_colors)
...
```{r 47-cluster_heatmap_region_cor, message = FALSE, warning = FALSE, results = "hide", fig.height = 30, fig.width = 30}
...
```{r 48-pseudobulk_pca_batch, message = FALSE, warning = FALSE, results = "hide"}
pseudobulk_pca(array, "orig.ident", "Batch", batch_colors_rna)
```

### Region-Type

```{r 49-pseudobulk_pca_region-type, message = FALSE, warning = FALSE, results = "hide"}
pseudobulk_pca(array, "Region_Type", "Region_Type", region_mol_type_colors)
```

# enrichR {.tabset}

```{r 50-start_enrichR, message = FALSE, warning = FALSE}
dbs <- c("GO_Molecular_Function_2018", "GO_Cellular_Component_2018", "GO_Biological_Process_2018", "KEGG_2016")
```

## Type {.tabset}

```{r 51-run_enrichR-type, message = FALSE, warning = FALSE, results = 'hide'}
...
### MOL.1 | MOL.Mast4 {.tabset}

```{r 52-enrichr_type_MOL.1|MOL.Mast4, message = FALSE, warning = FALSE, results = "hide"}
...
### MOL.2 | MOL.Prom1 {.tabset}

```{r 53-enrichr_type_MOL.2|MOL.Prom1, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 54-run_enrichR-region-type, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r 55-enrichr_aplCoA_type_MOL.1|MOL.Mast4, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 56-enrichr_pplCoA_type_MOL.1|MOL.Mast4, message = FALSE, warning = FALSE, results = "hide"}
