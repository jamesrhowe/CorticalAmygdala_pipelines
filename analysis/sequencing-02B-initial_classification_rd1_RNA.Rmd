...
params:
  id: "plCoA"
  input_path: "output/sequencing/02-semisupervised_rd1/"
  output_path: "output/sequencing/02-semisupervised_rd1/"
  dimn: 20
title: "Broad tissue type classification (cluster QC): `r params$id`"
...
array <- readRDS(paste0(input, "_merged_rd1_RNA.rds"))
```
...
```{r 32-tissue_dendrogram_region, message = FALSE, warning = FALSE, results = "hide"}
...
#### Tissue with Batch ID

```{r 33-tissue_dendrogram_batch, message = FALSE, warning = FALSE, results = "hide"}
# create region+class convolution ID
...
```{r 44-pseudobulk_pca_batch-tissue, message = FALSE, warning = FALSE, results = "hide"}
pseudobulk_pca(array, "Batch_Tissue", "Batch_Tissue", batch_tissue_colors_rna)
```
