...
params:
  id: "plCoA"
  class: "Nonneuron"
  input_path: "output/sequencing/04-subcluster_datasets-RNA/"
  output_path: "output/sequencing/03-processed_datasets-RNA/"
title: "Transform subclustered datasets (final): `r params$id` `r params$class`"
...
array <- readRDS(paste0(input, id, "_", cell_class, "_tissue_RNA.rds"))
...
saveRDS(array, file = paste0(output, id, "_", cell_class, "_reprocessed_RNA.rds"))
```
