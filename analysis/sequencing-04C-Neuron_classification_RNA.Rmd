...
glut_clusters <- c(0:6, 8, 12:13, 15, 17)
gaba_clusters <- c(7, 9:11, 14, 16)
...
```{r 28-dot_tg_neuro, message = FALSE, warning = FALSE, results = "hide", fig.height = 2, fig.width = 6}
array <- PrepSCTFindMarkers(array)

DotPlot_scCustom(array, features = marker_features_neuron, colors_use = dotplot_colors) + 
  theme(axis.ticks.x = element_blank(),
        axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
```
...
```{r 29-stacked_vln_marker, message = FALSE, warning = FALSE, results = "hide", fig.height = 12, fig.width = 12}
...
```{r 30-stacked_vln_marker_half, message = FALSE, warning = FALSE, results = "hide", fig.height = 5, fig.width = 6}
VlnPlot(array, features = marker_features_neuron, 
        pt.size = 0, stack = TRUE, flip = TRUE, 
        group.by = 'Class') + 
        theme(legend.position = 'none')
```
...
```{r 31-heatmap_marker, message = FALSE, warning = FALSE, results = "hide", dev = "png", fig.height = 8, fig.width = 16}
...
```{r 32-region_dendrogram, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 33-library_dendrogram, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 34-class_dendrogram_region, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 35-cluster_heatmap_region_dist, message = FALSE, warning = FALSE, results = "hide"}
dendrogram_heatmap(region_dend, method_id = "distance")
```

#### Correlation

```{r 36-cluster_heatmap_region_cor, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 37-cluster_heatmap_batch_dist, message = FALSE, warning = FALSE, results = "hide"}
dendrogram_heatmap(batch_dend, method_id = "distance")
```

#### Correlation

```{r 38-cluster_heatmap_batch_cor, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 39-cluster_heatmap_region_dist, message = FALSE, warning = FALSE, results = "hide", fig.height = 30, fig.width = 30}
dendrogram_heatmap(class_region_dend, method_id = "distance")
```

#### Correlation

```{r 40-cluster_heatmap_region_cor, message = FALSE, warning = FALSE, results = "hide", fig.height = 30, fig.width = 30}
...
```{r 41-pseudobulk_pca_batch, message = FALSE, warning = FALSE, results = "hide"}
pseudobulk_pca(array, "orig.ident", "Batch", batch_colors_rna)
```

### Region-Class

```{r 42-pseudobulk_pca_region-class, message = FALSE, warning = FALSE, results = "hide"}
pseudobulk_pca(array, "Region_Class", "Region_Class", region_neuron_class_colors)
```

# Split matrix into constituent parts and save

```{r 43-save_matrices, message = FALSE, warning = FALSE, results = "hide"}
...
write.csv(cluster_file, file = "output/sequencing/cluster_lists/04C-Neuron_class_clusters.csv", col.names = TRUE)
```
