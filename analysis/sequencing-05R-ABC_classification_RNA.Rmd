...
params:
  ...
  dimn: 9
title: "ABC cell type classification (final): `r params$id`"
...
absolute_bar_plot_formatted(plot_group_array, 'Region', 'Type', abc_type_colors)
```

#### Relative

```{r 29-region_relative, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 3}
relative_bar_plot_formatted(plot_group_array, 'Region', 'Type', abc_type_colors) +
...
absolute_bar_plot_formatted(plot_group_array, 'Batch', 'Type', abc_type_colors)
```

#### Relative

```{r 32-region_relative, message = FALSE, warning = FALSE, results = "hide", fig.height = 4, fig.width = 4}
relative_bar_plot_formatted(plot_group_array, 'Batch', 'Type', abc_type_colors) +
  geom_hline(yintercept = table(array$Type)[2] / length(array$Type), linetype = "dashed")
```
...
type_dend <- create_dendrogram(array, as.factor(array$Type), abc_type_colors)
...
pseudobulk_pca(array, "Region_Type", "Region_Type", region_abc_type_colors)
```
...
### ABC.1 | ABC.Slc4a10 {.tabset}

```{r 54-enrichr_type_ABC.1|ABC.Slc4a10, message = FALSE, warning = FALSE, results = "hide"}
...
### ABC.2 | ABC.Ranbp3l {.tabset}

```{r 55-enrichr_type_ABC.2|ABC.Ranbp3l, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 57-enrichr_aplCoA_type_ABC.1|ABC.Slc4a10, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 58-enrichr_pplCoA_type_ABC.1|ABC.Slc4a10, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 59-enrichr_pplCoA_type_ABC.2|ABC.Ranbp3l, message = FALSE, warning = FALSE, results = "hide"}
...
```{r 60-save_matrices, message = FALSE, warning = FALSE, results = "hide"}
